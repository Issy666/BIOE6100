...
Outputs:
  saved_figs/letters_ISABEL.jpg              - source image 
  saved_figs/name_isabel_population.png      - Fig.8b-style raster
  Data/name_isabel_sim_res.npy               - per-row Va traces
"""
import os
import numpy as np
...
np.save('Data/name_isabel_sim_res.npy', sim_res)


# ---------------------------------------------------------------------------
# Step 6 - plot Fig.8b-style [1] raster: EPS reference + SA1/RA1/PC rasters
# ---------------------------------------------------------------------------
def print_name_raster():
    ...
    buf  = eq_stimuli
    sres = np.load('Data/name_isabel_sim_res.npy', allow_pickle=True)
    ...
    plt.text(0, HEIGHT_MM + 2, 'Name on Fingertip - LNP', fontsize=12)
    ...
    out = 'saved_figs/name_isabel_population.png'

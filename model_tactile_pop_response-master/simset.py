...
def Visualizing_covering_areas_of_tactile_units(tsensors):
    ...
    buf=[]
    buf.append(np.load('Data/loc_pos_buf_fingertip.npy', allow_pickle=True))
    buf.append(np.load('Data/loc_pos_buf_bfinger.npy', allow_pickle=True) )
    buf.append(np.load('Data/loc_pos_buf_plam.npy', allow_pickle=True) )
    for area in range(1):
        for ch in range(3):
...
df=[np.load('Data/loc_pos_buf_fingertip.npy', allow_pickle=True),[],[]]
...
np.save('Data/loc_pos_buf_fingertip.npy',np.array(save_loc_data, dtype=object))   
save_loc_data=sim_all_setup(tsensors,bfingerroi,sT=1,sr=1000,Densitys=Densitys1[1])   
np.save('Data/loc_pos_buf_bfinger.npy',np.array(save_loc_data, dtype=object))  
save_loc_data=sim_all_setup(tsensors,plamroi,sT=1,sr=1000,Densitys=Densitys1[2]) 
np.save('Data/loc_pos_buf_plam.npy',np.array(save_loc_data, dtype=object))  
...
np.save('Data/loc_pos_low_density.npy',np.array([dt1, dt2, dt3], dtype=object))  
